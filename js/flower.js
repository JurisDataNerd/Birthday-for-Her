...
function alertMusic() {
    Swal.fire({
        ...
        var paragraphText2 = "Sebelumnya maaf ya, aku hanya bisa membuatkan ucapan sederhana seperti ini, desainnya juga cukup sederhana karena yak betul masih belajar, ga bisa berkata-kata manis atau yang berkesan. Tapi intinya aku cuman ingin mengucapkan selamat ulang tahun buatmu! Semakin tua dirimu berarti semakin dekat lagi kamu dengan cita-citamu menjadi seorang dokter! Semoga apa yang kamu harapkan jadi kenyataan, semoga tahun ini menjadi tahun yang berkesan buatmu, tahun yang penuh joy, laughter, and happiness. I wish nothing but the best for you.";
        var paragraphText3 = "Mba Dinda yang kuat ya menghadapi segala tantangan dan ujian selama Koas, jauh dari keluarga dan orang-orang yang disayang, but i know you are a very strong, independent, inspiring individual, so if you believe you can do it, then you can do it!"
